...
<body onload="myFunction()">
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <td
                                        ...
                                        <p
                                            style='margin:0in;margin-bottom:.0001pt;font-size:15px;font-family:"Arial",sans-serif;border:none;'>
                                            <strong><span style="color:#14144A;">{{ $student->first_name }}
                                    ...
                                    <td
                                        ...
                                        <p
                                            style='margin:0in;margin-bottom:.0001pt;font-size:15px;font-family:"Arial",sans-serif;border:none;'>
                                            <strong><span style="color:#14144A;">{{ $student->course }}</span></strong>
                                        </p>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td
                                        ...
                                        <p
                                            style='margin:0in;margin-bottom:.0001pt;font-size:15px;font-family:"Arial",sans-serif;border:none;'>
                                            <strong><span style="color:#14144A;">{{ $student->email }}</span></strong>
                                        </p>
                                    </td>
                                    <td
                                    ...
                                    @if ($data->status == null)
                                        <tr>
                                            ...
                                            <td
                                                ...
                                                <p
                                                    style='margin:0in;margin-bottom:.0001pt;font-size:15px;font-family:"Arial",sans-serif;text-align:center;border:none;'>
                                                    <span style="color:white;background:#14144A;">Pending</span>
                                                </p>
                                            </td>
                                        </tr>
                                    @elseif($data->status == 'Approved')
                                        <tr>
                                            ...
                                            <td
                                                ...
                                                <p
                                                    style='margin:0in;margin-bottom:.0001pt;font-size:15px;font-family:"Arial",sans-serif;text-align:center;border:none;'>
                                                    <span style="color:white;background:#14144A;">Approved</span>
                                                </p>
                                            </td>
                                        </tr>
                                    @elseif($data->status == 'Rejected')
                                        <tr>
                                            ...
                                            <td
                                                ...
                                                <p
                                                    style='margin:0in;margin-bottom:.0001pt;font-size:15px;font-family:"Arial",sans-serif;text-align:center;border:none;'>
                                                    <span style="color:white;background:red;">Rejected</span>
                                                </p>
                                            </td>
                                        </tr>
                                    @endif
                        ...
                        <div class="col-md-12">
                            <center>
                                ...
                                <p
                                    ...
                                    <strong><u><span style="text-decoration:none;">&nbsp;</span></u></strong>
                                </p>
                                <p
                                    style='margin:0in;margin-bottom:.0001pt;font-size:15px;font-family:"Arial",sans-serif;text-align:justify;text-indent:.5in;line-height:115%;border:none;'>
                                    <strong><u><span style="text-decoration:none;">&nbsp;</span></u></strong>
    ...
    <button id="trigger" style="display: none" class="btn btn-sm btn-success float-right"
